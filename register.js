...
const registerBtn = document.getElementById("registerBtn");
  ...
  registerBtn?.addEventListener("click", function () {
    ...
    window.location.href =
      ...
      "&age=" +
      encodeURIComponent(user.age) +
      "&city=" +
      encodeURIComponent(user.city);
...
console.log(passwordFromRegister)
  ...
  loginBtn?.addEventListener("click", function (event) {
    ...
    if (
      ...
      window.location.href =
        "dashboard.html?name=" +
        encodeURIComponent(nameFromRegister) +
        "&email=" +
        encodeURIComponent(emailFromRegister) +
        "&age=" +
        encodeURIComponent(ageFromRegister) +
        "&city=" +
        encodeURIComponent(cityFromRegister);
    } else {
